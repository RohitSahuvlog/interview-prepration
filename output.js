...
// why? null == undefined is true because both are falsy values. In JavaScript, null and undefined are equal to each other and don't equal to anything else.
// Answer: true

// Question: If var a = 2, b =3 what would be value of a && b
// Answer: 3. The && operator returns the value of the last operand if all other operands are truthy. In this case, both a and b are truthy, so the last operand b is returned.
// Answer: 3
