// In this lab, you will be implementing a Promise Pool.A Promise Pool is a technique used to limit the number of concurrently executing promises, which can be useful in cases such as API rate - limiting or managing a limited number of resources.
...
// 1 <= n <= 10
// Challenges
// Implement the promisePool function.
// Ensure that promisePool works correctly for different pool limits.
// Make sure to export the promisePool function using ESM Syntax