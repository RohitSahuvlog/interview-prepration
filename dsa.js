...
function exist(board, word) {
    ...
    function dfs(row, col, index) {
        ...
        console.log(visited, "visited", row, col, index);
...
// Space complexity: O(L) where L is the length of the word to be matched. The depth of the recursion tree can go up to L.
